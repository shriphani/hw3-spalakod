...
public class Token_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.f14.hw3.hw3_spalakod.typesystems.Token");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "edu.cmu.lti.f14.hw3.hw3_spalakod.typesystems.Token");
  ...
  public int getFrequency(int addr) {
      ...
      jcas.throwFeatMissing("frequency", "edu.cmu.lti.f14.hw3.hw3_spalakod.typesystems.Token");
