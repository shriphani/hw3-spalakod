 ...
 * 
 */
package edu.cmu.lti.f14.hw3.hw3_spalakod;
...
public class VectorSpaceRetrievalImproved {
  ...
  public static void main(String [] args) 
    ...
    URL descUrl = VectorSpaceRetrieval.class.getResource("/descriptors/retrievalsystem/VectorSpaceRetrievalImproved.xml");
     if (descUrl == null) {
